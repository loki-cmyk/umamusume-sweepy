...
REF_MANT_RACE_TRY_AGAIN_DISABLED = Template("mant_try_again_disabled", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_area=Area(60, 1130, 360, 1230), match_accuracy=0.70))
