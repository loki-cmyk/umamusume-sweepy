...
REF_UNITY_CUP_SPLASH = Template("UNITY_CUP_SPLASH", UMAMUSUME_REF_TEMPLATE_PATH)
...
REF_RACE_LIST = Template("race_list", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_area=Area(0, 0, 100, 33), match_accuracy=0.83))
...
REF_SELECT_OPP2 = Template("select_opp2", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_area=Area(315, 1085, 385, 1115), match_accuracy=0.80))
REF_ALL_RES = Template("all_res", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_area=Area(470, 1200, 600, 1222), match_accuracy=0.80))
REF_RACE_END = Template("race_end", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_area=Area(120, 40, 415, 75), match_accuracy=0.80))
REF_RACE_END2 = Template("race_end2", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_area=Area(300, 1190, 570, 1240), match_accuracy=0.80))
REF_TEAM_SHOWDOWN = Template("team_showdown", UMAMUSUME_REF_TEMPLATE_PATH)
REF_BEGIN_SHOWDOWN = Template("begin_showdown", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_area=Area(430, 875, 605, 960), match_accuracy=0.80))
